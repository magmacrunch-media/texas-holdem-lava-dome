...
# happened. bin2s emits one assembly blob plus a header of symbols; -a 32 matches
# ASND's DMA alignment so audio plays straight out of the image with no copy.
...
test: test-hand-eval test-dome test-anim
